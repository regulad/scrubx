...
LABEL org.opencontainers.image.title="scrubx"
LABEL org.opencontainers.image.version="0.1.0"
LABEL org.opencontainers.image.url="https://github.com/regulad/scrubx"
LABEL org.opencontainers.image.documentation="https://scrubx.readthedocs.io"
...
COPY --from=builder /code/dist/scrubx-*.whl /tmp/
RUN pip install --user /tmp/scrubx-*.whl

# Now do something!
CMD ["/home/scrubx/.local/bin/scrubx"]
